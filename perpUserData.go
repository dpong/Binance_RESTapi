...
type PerpAccountSnapShotResponse struct {
...
type PerpAccountSnapShotOpts struct {
...
func (b *Client) GetPerpAccountSnapshot() (*PerpAccountSnapShotResponse, error) {
	opts := PerpAccountSnapShotOpts{
		TimeStamp: time.Now().UnixMilli(),
	}

	res, err := b.do("future", http.MethodGet, "fapi/v2/account", opts, true, false)
	if err != nil {
		return nil, err
	}

	resp := &PerpAccountSnapShotResponse{}
